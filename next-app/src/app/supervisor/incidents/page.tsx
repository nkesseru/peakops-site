...
export default function SupervisorIncidentsPage() {
  ...
  return (
    <div style={{ padding: 24, fontFamily: "system-ui" }}>
      <h1 style={{ fontSize: 22, fontWeight: 800, margin: 0 }}>Supervisor · Incidents</h1>
      ...
      <div style={{ display: "flex", gap: 12, alignItems: "center", marginTop: 12, flexWrap: "wrap" }}>
        ...
        <button disabled={busy} onClick={createIncident} style={{ padding: "8px 12px", borderRadius: 10, border: "1px solid #ccc" }}>
            ...
            {incidents.map((it: any) => (
              <li key={it.id} style={{ border: "1px solid #e5e5e5", borderRadius: 12, padding: 12 }}>
                <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
                  ...
                  <Link
                    href={`/supervisor/incidents/${encodeURIComponent(it.id)}?orgId=${encodeURIComponent(orgId)}`}
