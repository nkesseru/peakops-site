...
FILE="next-app/src/app/admin/_components/TimelinePreviewMock.tsx"
TS="$(date +%Y%m%d_%H%M%S)"
cp "$FILE" "$FILE.bak_$TS" 2>/dev/null || true
...
echo "==> quick verify file header"
head -n 5 "$FILE"

echo "✅ TimelinePreviewMock upgraded"
