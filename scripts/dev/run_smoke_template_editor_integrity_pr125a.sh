...
# PR 125a Template Editor Integrity backend smoke, and tear down.
set -euo pipefail
...
EMU_LOG="$ROOT/.logs/emu_pr125a.log"
mkdir -p "$ROOT/.logs"
: > "$EMU_LOG"
...
node "$ROOT/scripts/dev/smoke_template_editor_integrity_pr125a.mjs"
SMOKE_RC=$?
