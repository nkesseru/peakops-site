...
exports.reliabilityIngest = void 0;
 ...
 */
function validateReliabilityRow(raw, index) {
    ...
    const isBad = saidi > 1000 || saifi > 100 || caidi > 100 || Number.isNaN(saidi) || Number.isNaN(saifi) || Number.isNaN(caidi);
 ...
 */
function makeMetricId(orgId, regionId, year) {
    return `${orgId}_${regionId}_${year}`;
}
// ----- Main function -----
exports.reliabilityIngest = (0, https_1.onRequest)(async (req, res) => {
    try {
        // --- Auth / method checks ---
        ...
        const { orgId, source, rows, regionId = "SYSTEM", importedBy = "SYSTEM", sourceFileName, } = req.body || {};
        ...
        const safeSourceFileName = typeof sourceFileName === "string" && sourceFileName.length > 0
            ? sourceFileName
            : null;
